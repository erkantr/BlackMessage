...
import com.blackmessage.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> implements Filterable {
    ...
    public UserAdapter(Context mContext, List<User> mUsers, boolean ischat) {
        ...
        this.ischat = ischat;
        this.searchList = new ArrayList<>(mUsers);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (ischat) {
            ...
            holder.last_msg.setText(user.getHakkimda());
        }
    ...
    private void lastMessage(final String userid, final TextView last_msg) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance(MainActivity.url).getReference("Chats");
